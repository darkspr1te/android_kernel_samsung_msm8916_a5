...
#if defined(CONFIG_SEC_A5_PROJECT) || defined(CONFIG_SEC_A5_EUR_PROJECT) || defined(CONFIG_SEC_A53G_EUR_PROJECT) || defined(CONFIG_SEC_E7_EUR_PROJECT)
		data->accdata.x = data->accdata.x >> 4;
		data->accdata.y = data->accdata.y >> 4;
		data->accdata.z = data->accdata.z >> 4;
		/*pr_err("%s) %d %d %d\n", __func__, data->accdata.x, data->accdata.y, data->accdata.z);*/
#endif
	} else {
		acc = data->accdata;
	}
