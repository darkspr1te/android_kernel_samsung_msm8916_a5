 ...
 *
 * drivers/video/dct/sec_dct_msm8610.c - Set display tunning data from MSM8610
 *
...
static int dct_setAllData(char *recv_data)
{
	...
	//dct_data.disphy_timing_ctrl[3] = 0;
...
void dct_applyData(struct fb_info *info)
{
	...
	if (!bdct_data_backup) {
		...
		dct_data.disphy_timing_ctrl[3] = pinfo->mipi.dsi_phy_db.timing[3];
