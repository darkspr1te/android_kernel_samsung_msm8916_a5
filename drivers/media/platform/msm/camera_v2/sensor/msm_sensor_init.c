...
static DEVICE_ATTR(rear_camtype, S_IRUGO|S_IWUSR|S_IWGRP, back_camera_type_show, NULL);
...
static DEVICE_ATTR(isp_core, S_IRUGO|S_IWUSR|S_IWGRP, rear_camera_isp_core_show, NULL);
static DEVICE_ATTR(front_camtype, S_IRUGO|S_IWUSR|S_IWGRP, front_camera_type_show, NULL);
