...
#define SINKING_PERIOD  2000
	...
	|| defined(CONFIG_SEC_A5_PROJECT) || defined(CONFIG_SEC_E7_PROJECT)
		...
		int onoff)
{
	...
	int rev_id;
	rev_id = rt5033_reg_read(iic, 0x03) & 0x0f;
		...
		int current_limit)
{
	...
	#elif defined(CONFIG_SEC_VASTA3G_PROJECT) || defined(CONFIG_SEC_A5_EUR_PROJECT) || defined(CONFIG_SEC_A53G_EUR_PROJECT) \
	|| defined(CONFIG_SEC_A5_PROJECT) || defined(CONFIG_SEC_E7_PROJECT)
